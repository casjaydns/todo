...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTodosCardTodosCardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _todos_card_todos_card_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./todos-card/todos-card.component */
    ...
    var routes = [{
      path: '',
      component: _todos_card_todos_card_component__WEBPACK_IMPORTED_MODULE_3__["TodosCardComponent"],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _todos_card_todos_card_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./todos-card/todos-card.component */
    "./src/app/todos-card/todos-card.component.ts");
    /* harmony import */


    var _todo_todo_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./todo/todo.component */
    ...
    var _services_auth_interceptor_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _todos_card_todos_card_component__WEBPACK_IMPORTED_MODULE_8__["TodosCardComponent"], _todo_todo_component__WEBPACK_IMPORTED_MODULE_9__["TodoComponent"], _signup_signup_component__WEBPACK_IMPORTED_MODULE_10__["SignupComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_11__["LoginComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["NoopAnimationsModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_7__["MatIconModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_15__["MatButtonModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_16__["MatSnackBarModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_12__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]],
  ...
  function srcAppGuardsAuthGuardTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthGuard = /*#__PURE__*/function () {
      function AuthGuard(auth, router, snackbar, storage) {
      ...
      _createClass(AuthGuard, [{
        ...
        value: function canActivate(route, state) {
          ...
          return this.auth.isAuthenticated().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (e) {
            if (e.status === 401) {
              _this.router.navigate(['/login']);

              _this.storage.removeAuthData();

              return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(false);
            } else {
              _this.snackbar.open('We have run into a problem. Try again later');
  ...
  /***/
  function srcAppInterfacesTodoStatusTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TodoStatus", function () {
      return TodoStatus;
    });
    /* harmony import */
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(snackbar, activatedRoute, fb, auth, storage, router) {
      ...
      _createClass(LoginComponent, [{
        ...
        key: "canLoginSnack",
        value: function canLoginSnack() {
          var _this2 = this;

          this.activatedRoute.queryParams.subscribe(function (params) {
            if (params.signedUp) _this2.snackbar.open('Now you can login');
          });
        }
      }, {
        key: "login",
        value: function login() {
          ...
          this.auth.login(this.form.value).subscribe(function (response) {
            _this3.storage.setAuthData({
            ...
            console.log(error);
            if (error.error.error && error.error.error === 'User not found') _this3.snackbar.open('User not found');else if (error.error.error && error.error.error === 'Password not correct') _this3.snackbar.open('Password incorrect');else _this3.snackbar.open('We have run into a problem. Try again later');
          });
        }
      }]);
  ...
  function srcAppServicesAuthInterceptorServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthInterceptorService = /*#__PURE__*/function () {
      function AuthInterceptorService(storage, http, auth, handler) {
      ...
      _createClass(AuthInterceptorService, [{
        ...
        value: function intercept(req, next) {
          ...
          if (this.storage.getJwt()) req = req.clone({
            setHeaders: {
              Authorization: this.storage.getJwt()
            }
          });
          return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            if (error.error.error && error.error.error === 'TokenExpired') {
              return _this4.auth.refreshTokens().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () {
                return _this4.handler.handle(req);
              }));
            } else return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(error);
          }));
        }
      }]);
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _environments_apis__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../environments/apis */
    ...
    var AuthService = /*#__PURE__*/function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function refreshTokens() {
          ...
          return this.http.post(_environments_apis__WEBPACK_IMPORTED_MODULE_3__["APIs"].refreshTokens(this.storage.getUserId()), null, {
            headers: {
              Refresh: this.storage.getRefresh()
            }
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (data) {
            _this5.storage.setAuthData({
              userId: data.user._id,
              jwt: 'Bearer ' + data.newAccessToken,
              refresh: 'Bearer ' + data.newRefreshToken
            });
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            if (error.status !== 0) _this5.storage.removeAuthData();
  ...
  function srcAppServicesSnackbarServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SnackbarService = /*#__PURE__*/function () {
      ...
      _createClass(SnackbarService, [{
        key: "open",
        value: function open(message, action, duration) {
  ...
  function srcAppServicesStorageServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var StorageService = /*#__PURE__*/function () {
      ...
      _createClass(StorageService, [{
        ...
        key: "setAuthData",
        value: function setAuthData(_ref) {
  ...
  function srcAppServicesTodosServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _interfaces_todo_status__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../interfaces/todo-status */
    "./src/app/interfaces/todo-status.ts");
    /* harmony import */
    ...
    var _environments_apis__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../environments/apis */
    "./src/environments/apis.ts");
    /* harmony import */
    ...
    var TodosService = /*#__PURE__*/function () {
      function TodosService(storage, http) {
      ...
      _createClass(TodosService, [{
        key: "filterTodos",
        value: function filterTodos(status) {
          switch (status) {
        ...
        value: function fetchTodos() {
          ...
          return this.http.get(_environments_apis__WEBPACK_IMPORTED_MODULE_4__["APIs"].user(this.storage.getUserId())).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (user) {
            _this6.todos = user.todos;
            _this6.tasksLeft = _this6.todos.filter(function (item) {
              return item.completed === false;
            }).length;
          }));
        }
        ...
        key: "createTodo",
        value: function createTodo(title) {
          var _this7 = this;

          return this.http.post(_environments_apis__WEBPACK_IMPORTED_MODULE_4__["APIs"].todos(this.storage.getUserId()), {
            title: title
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (todo) {
            _this7.todos.unshift(todo);
        ...
        value: function deleteTodo(todo) {
          ...
          return this.http["delete"](_environments_apis__WEBPACK_IMPORTED_MODULE_4__["APIs"].todo(this.storage.getUserId(), todo._id)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function () {
            _this8.tasksLeft += todo.completed ? 0 : -1;

            var deleteIdx = _this8.todos.findIndex(function (item) {
              return item._id === todo._id;
            });

            _this8.todos.splice(deleteIdx, 1);
          }));
        }
      }, {
        key: "toggleTodo",
        value: function toggleTodo(todo) {
          ...
          return this.http.patch(_environments_apis__WEBPACK_IMPORTED_MODULE_4__["APIs"].todo(this.storage.getUserId(), todo._id), null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function () {
            todo.completed = !todo.completed;
            _this9.tasksLeft += todo.completed ? -1 : 1;
          }));
        }
      }, {
        key: "completeAllTodos",
        value: function completeAllTodos() {
          var _this10 = this;

          return this.http.patch(_environments_apis__WEBPACK_IMPORTED_MODULE_4__["APIs"].todos(this.storage.getUserId()), null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function () {
            _this10.todos.forEach(function (todo) {
        ...
        value: function deleteCompletedTodos() {
          var _this11 = this;

          return this.http["delete"](_environments_apis__WEBPACK_IMPORTED_MODULE_4__["APIs"].todos(this.storage.getUserId())).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function () {
  ...
  function srcAppSignupSignupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignupComponent = /*#__PURE__*/function () {
      function SignupComponent(fb, auth, router, snackbar, storage) {
      ...
      _createClass(SignupComponent, [{
        ...
        value: function passwordMatchValidator(form) {
          return form.controls['password'].value === form.controls['passwordConfirm'].value ? null : {
            'mismatch': true
          };
        }
      }, {
        ...
        value: function signup() {
          ...
          this.auth.signup(this.form.value).subscribe(function (response) {
            _this12.form.reset();
            ...
            if (error.error.error && error.error.error.slice(0, 37) === 'E11000 duplicate key error collection') _this12.snackbar.open('User already exists. Forgot password?', 'Yes', 5000);else _this12.snackbar.open('We have run into a problem. Try again later');
          });
        }
      }]);
  ...
  function srcAppTodoTodoComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var TodoComponent = /*#__PURE__*/function () {
      function TodoComponent(todosService, snackbar, router) {
      ...
      _createClass(TodoComponent, [{
        ...
        value: function deleteTodo(todo) {
          ...
          this.todosService.deleteTodo(todo).subscribe(function (response) {
            _this13.onChange.emit();
          }, function (error) {
            if (error.status === 401) _this13.router.navigate(['login']);else _this13.snackbar.open('We have run into a problem. Try again later');
          });
        }
      }, {
        key: "toggleTodo",
        value: function toggleTodo(todo) {
          ...
          this.todosService.toggleTodo(todo).subscribe(function (response) {
            _this14.onChange.emit();
          }, function (error) {
            if (error.status === 401) _this14.router.navigate(['login']);else _this14.snackbar.open('We have run into a problem. Try again later');
          });
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], TodoComponent.prototype, "onChange", void 0);
  ...
  /***/
  function srcAppTodosCardTodosCardComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTodosCardTodosCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TodosCardComponent", function () {
      return TodosCardComponent;
    });
    /* harmony import */
    ...
    var _services_todos_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../services/todos.service */
    "./src/app/services/todos.service.ts");
    /* harmony import */
    ...
    var TodosCardComponent = /*#__PURE__*/function () {
      function TodosCardComponent(todosService, snackbar, router) {
        _classCallCheck(this, TodosCardComponent);
      ...
      _createClass(TodosCardComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.fetchUser();
        }
        ...
        value: function fetchUser() {
          ...
          this.todosService.fetchTodos().subscribe(function (response) {
            return _this15.getTodos();
          }, function (error) {
            if (error.status === 401) _this15.router.navigate(['login']);else _this15.snackbar.open('We have run into a problem. Try again later');
          });
        }
      }, {
        key: "createTodo",
        value: function createTodo($event) {
          ...
          this.todosService.createTodo(input.value).subscribe(function (todo) {
            input.value = '';

            _this16.getTodos();
          }, function (error) {
            if (error.status === 401) _this16.router.navigate(['login']);else _this16.snackbar.open('We have run into a problem. Try again later');
          });
        }
      }, {
        key: "completeAllTodos",
        value: function completeAllTodos() {
          ...
          this.todosService.completeAllTodos().subscribe(function () {
            return _this17.getTodos();
          }, function (error) {
            if (error.status === 401) _this17.router.navigate(['login']);else _this17.snackbar.open('We have run into a problem. Try again later');
          });
        }
      }, {
        key: "deleteCompletedTodos",
        value: function deleteCompletedTodos() {
          ...
          this.todosService.deleteCompletedTodos().subscribe(function () {
            return _this18.getTodos();
          }, function (error) {
            if (error.status === 401) _this18.router.navigate(['login']);else _this18.snackbar.open('We have run into a problem. Try again later');
          });
        }
      }]);
    ...
    TodosCardComponent.ctorParameters = function () {
      return [{
    ...
    TodosCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-todos-card',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./todos-card.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/todos-card/todos-card.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./todos-card.component.scss */
      "./src/app/todos-card/todos-card.component.scss"))["default"]]
    })], TodosCardComponent);
    /***/
  },
  ...
  /***/
  function srcEnvironmentsApisTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var APIs = {
      authorization: function authorization() {
        return _environment__WEBPACK_IMPORTED_MODULE_1__["environment"].URL + '/api/v1/auth/check-authorization';
      },
      login: function login() {
        return _environment__WEBPACK_IMPORTED_MODULE_1__["environment"].URL + '/api/v1/auth/login';
      },
      signup: function signup() {
        return _environment__WEBPACK_IMPORTED_MODULE_1__["environment"].URL + '/api/v1/auth/signup';
      },
      refreshTokens: function refreshTokens(userId) {
        return _environment__WEBPACK_IMPORTED_MODULE_1__["environment"].URL + '/api/v1/auth/refresh/' + userId;
      },
      user: function user(userId) {
        return _environment__WEBPACK_IMPORTED_MODULE_1__["environment"].URL + '/api/v1/users/' + userId;
      },
      todos: function todos(userId) {
        return _environment__WEBPACK_IMPORTED_MODULE_1__["environment"].URL + '/api/v1/users/' + userId + '/todos';
      },
      todo: function todo(userId, todoId) {
        return _environment__WEBPACK_IMPORTED_MODULE_1__["environment"].URL + '/api/v1/users/' + userId + '/todos/' + todoId;
      }
    };
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/casjay/node-todo-third/client/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
